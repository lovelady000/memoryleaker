...
public class BatteryStatus {
     ...
     */
    public BatteryStatus(Intent batteryIntent) {
    ...
    public int getLiveTime() {
        ...
        if (timeOfDay >= 0 && timeOfDay < 12) {
            return BatteryStatus.LIVE_TIME_MORNING;
        } else if (timeOfDay >= 12 && timeOfDay < 16) {
            return BatteryStatus.LIVE_TIME_AFTERNOON;
        } else if (timeOfDay >= 16 && timeOfDay < 21) {
            return BatteryStatus.LIVE_TIME_EVENING;
        } else if (timeOfDay >= 21 && timeOfDay < 24) {
            return BatteryStatus.LIVE_TIME_NIGHT;
        } else {
            return -1;
        }
    ...
    public int getPluggedState() {
        ...
        if (plug == BatteryManager.BATTERY_PLUGGED_AC)
            return BatteryStatus.PLUGGED_STATE_AC;
        else if (plug == BatteryManager.BATTERY_PLUGGED_USB)
            return BatteryStatus.PLUGGED_STATE_USB;
        else if (plug == BatteryManager.BATTERY_PLUGGED_WIRELESS)
            return BatteryStatus.PLUGGED_STATE_WIRELESS;
        else
            return BatteryStatus.PLUGGED_STATE_UNKNOWN;
    ...
    public String getTemperatureText(boolean fahrenheit) {
        return String.valueOf(getTemperature(fahrenheit)) + BatteryStatus.DEGREE + "C";
    }
